...
public class F_Triple {
	 ...
	 * - 조건식의 결과가 true 이면 식 1을 수행한다.
	 * - 조건식의 결과가 false 이면 식 2를 수행한다.
	 * */
...
//		if(number > 0) { 
//			System.out.print("양수이다.");
//			}
//		else if(number < 0){ 
//			System.out.print("음수이다.");
//			}
//		else { 
...
//			};
		...
		// 조건식 ? 값1 : 값2;
//		String num = number > 0 ? "양수이다." : number == 0 ? "0이다." : "음수이다.";
...
//	}
	 ...
	 * 실습문제 1
	 * 
	 * 사용자한테 두개의 정수값을 입력받아서 두 정수의 곱셈 결과 100보다 크거나 같은 경우
	 * "결과가 100 이상입니다. " 아닌경우 " 결과가 100보다 적습니다." 출력	 * 
	 * */
