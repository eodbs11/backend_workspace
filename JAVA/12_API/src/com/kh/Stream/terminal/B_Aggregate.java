...
//		b.method1();
	...
	/*
	 * 기본 집계
	 * - 최종처리 기능으로 요소들을 개수, 합꼐 , 평균값, 최대값, 최소값 등과 같이
	 * 하나의 값으로 산출하는 역할
	 * - count : 요소의 개수 리턴
	 * - sum : 요소들의 합계 리턴
	 * - average : 요소들의 평균 리턴
	...
	public void method1() {
		...
		//ifPresent : 값이 저장되어 있을 경우 처리(if+ is Present)
